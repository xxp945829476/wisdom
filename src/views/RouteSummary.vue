    ...
    <div class="big_screen" ref="big_screen">
        ...
        <div class="monitor_display_content">
            ...
            <div class="monitor_display_map">
                ...
                <div class="map_box">
                    <div id="bm-view" ref="mapChart" class="bm-view"></div>
                </div>
...
export default {
    ...
    mounted(){
       ...
       this.$nextTick(()=>{
         ...
         const BJData = [
            { name: "龙信家园", value: 95,type:1},//excavate出土总量 backfill回填总量
...
var lines = lineData.map(function (track) {
      ...
      const color =['#f864b4', '#ae8108', '#ff0000', '#7664f8'];
    ...
    methods:{
        ...
        convertData(data) {
            ...
            for (let i = 0; i < data.length; i++) {
                ...
                const geoCoord = this.geoCoordMap[dataItem.name];
            
                if (geoCoord&&dataItem.type!=3) {
                    res.push({
                        name: dataItem.name,
                        value: geoCoord,
...
<style scoped lang='less'>
    ...
    .big_screen{
        background: url(../assets/images/rlt.png) #0e1c33 center 5vh no-repeat;
