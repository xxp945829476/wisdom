...
<script>
import {GetJsession,GetVideoFileInfo,Vehiclelist,QueryDownloadReplay,QueryFtpStatus,FtpUpload,SubVideoDownload} from "@/network/api"
export default {
  data () {
    const columns = [
